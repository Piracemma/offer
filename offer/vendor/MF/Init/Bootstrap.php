...
//atribuindo define() para todo o sistema
//atribuindo define() para todo o sistema
//atribuindo define() para todo o sistema

//Host Atual
define('HOST_APLIC','http://localhost:9000/'); //quando subir para o site alterar para endereco do site
...
//Caminho Views
define('PATH_VIEW','../offer_oficial/App/Views/');

//coockie definições
define('COOKIE_DOMAIN', 'localhost'); //quando for pro site alterar para 'offerbr.com.br' sem 'www'
define('COOKIE_SECURE', false); //de ser enviado somente por HTTPS
